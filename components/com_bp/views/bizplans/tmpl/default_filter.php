...
<div class="">
			...
			<label for="filter_search" class="element-invisible"
				...
				<button type="submit" class="btn btn-secondary"><?php echo JText::_('COM_BP_SEARCH_FILTER_SUBMIT'); ?></button>
			...
			<?php endif; ?>
				...
				<button type="button" class="btn btn-warning js-stools-btn-clear" title=""
