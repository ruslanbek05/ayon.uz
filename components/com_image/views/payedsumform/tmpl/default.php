...
<div class="payedsum-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-payedsum"
			  action="<?php echo JRoute::_('index.php?option=com_image&task=payedsum.save'); ?>"
	...
	<?php echo $this->form->renderField('imagelist'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_image&task=payedsumform.cancel'); ?>"
