...
<?php
$order_total = number_format($this->orderDetails['details']['BT']->order_total, 2, ',', ' ');
?>

<h3>dehqonbozori.uz нинг банк реквизитлари:</h3>
<p>Номи: "Ayon investment fund" МЧЖ</p>
<p>Ҳисобварағи: 20208000500800146001</p>
<p>СТИР (ИНН): 305052217</p>
<p>Банк номи: "Ўзсаноатқурилишбанк" АТБ Тошкент шаҳар минтақавий филиали</p>
<p>Банк МФОси: 00424</p>
<p>&nbsp;</p>
...
echo $order_total;
echo $this->orderDetails['details']['BT']->address_1;
echo $this->orderDetails['details']['BT']->last_name;
echo $this->orderDetails['details']['BT']->first_name;*/
?>
