 ...
 * @since  1.6
 */
class BpViewVotes extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		$canDo = BpHelpersBp::getActions();

		JToolBarHelper::title(JText::_('COM_BP_TITLE_VOTES'), 'votes.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_bp&view=votes');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`id_bizplantext`' => JText::_('COM_BP_VOTES_ID_BIZPLANTEXT'),
			'a.`id_users`' => JText::_('COM_BP_VOTES_ID_USERS'),
			'a.`id_bizplans`' => JText::_('COM_BP_VOTES_ID_BIZPLANS'),
		);
	}
}
