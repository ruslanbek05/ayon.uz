...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'bizplan.cancel') {
			Joomla.submitform(task, document.getElementById('bizplan-form'));
		}
		else {
			
			if (task != 'bizplan.cancel' && document.formvalidator.isValid(document.id('bizplan-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="bizplan-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_BP_TITLE_BIZPLAN', true)); ?>
		<div class="row-fluid">
			...
			?>				<?php echo $this->form->renderField('description'); ?>
				...
				<?php echo $this->form->renderField('feautured_0_255'); ?>
